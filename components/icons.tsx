...
export const PrimeVideoIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12.31,8.12a.5.5,0,0,0-.62,0L7.5,11.53V8.5h-1V16h1v-3.53l4.19-3.41A.5.5,0,0,0,12.31,8.12ZM18,12.2a3.39,3.39,0,0,1-1.87.55,1.75,1.75,0,0,1-1.58-1.74,1.83,1.83,0,0,1,1.82-1.82,1.73,1.73,0,0,1,1.63,1.75v.23a.48.48,0,0,0,1,0V11A2.76,2.76,0,0,0,16.2,8.19,2.8,2.8,0,0,0,13.5,11a2.76,2.76,0,0,0,2.73,2.81,3.44,3.44,0,0,0,2.53-1,.5.5,0,0,0-.76-.65Z" />
        <path d="M21.5,4H2.5A.5.5,0,0,0,2,4.5v15a.5.5,0,0,0,.5.5h19a.5.5,0,0,0,.5-.5V4.5A.5.5,0,0,0,21.5,4Zm-.5,15H3V5H21Z" />
    </svg>
);
...
export const Share2Icon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const SyncIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
